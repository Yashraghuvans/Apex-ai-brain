...
When asked to design a solution or generate code:
...
- **Pathing:** Save Apex classes to `force-app/main/default/classes/<ClassName>.cls`.
- **FSD Layers:** 
  - Service: `force-app/main/default/classes/<Object>Service.cls`
  - Selector: `force-app/main/default/classes/<Object>Selector.cls`
  - Domain: `force-app/main/default/classes/<Object>Domain.cls`
- **Metadata:** Don't forget the accompanying `-meta.xml` file for each class.
- **Bulkification:** Ensure all logic is bulk-ready; NO SOQL or DML in loops.
- **Security:** Use `WITH SECURITY_ENFORCED` and check `Schema.sObjectType` access.
